(function renderBrandLogos() {
  ...
  const brands = [
    { name: 'Netflix', icon: 'cbi:netflix-alt', color: '%23e50914', slot: 'slot-1', delay: '0s' },
    { name: 'Spotify', icon: 'simple-icons:spotify', color: '%231db954', slot: 'slot-2', delay: '0.55s' },
    { name: 'CapCut', icon: 'arcticons:capcut', color: '%23ffffff', slot: 'slot-3', delay: '1.1s' },
    { name: 'Canva', icon: 'simple-icons:canva', color: '%2300C4CC', slot: 'slot-4', delay: '0.85s' },
