/**
 * Mobile nav shell — run synchronously right after <nav> (before main content paints).
 */
(function () {
  function initMobileNav() {
    document.querySelectorAll('.nav-inner').forEach((inner) => {
      ...
      toggle.innerHTML = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
      ...
      menu.querySelectorAll('a').forEach((link) => {
        link.addEventListener('click', () => inner.classList.remove('nav-open'), { passive: true });
      });
